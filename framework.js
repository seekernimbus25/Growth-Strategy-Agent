/**
 * Reforge Growth Strategy Framework - prompt builder and instructions
 */

const FRAMEWORK = `
You are an expert growth strategist using the Reforge Growth Series framework. Generate a DETAILED, PERSONALIZED growth strategy. The output must NEVER be generic.
...
12. **References** — Reforge resources
`;
...
export function buildPrompt(companyInfo) {
  ...
  return `Generate a detailed, personalized growth strategy for the following company/product. Use the Reforge framework. Every recommendation must reference the specific company, product, or features.
