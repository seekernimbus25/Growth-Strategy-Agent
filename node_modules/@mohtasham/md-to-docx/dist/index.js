import { Document, Paragraph, TextRun, AlignmentType, PageOrientation, Packer, InternalHyperlink, Footer, PageNumber, LevelFormat, } from "docx";
 ...
 * @throws {MarkdownConversionError} If conversion fails
 */
export async function parseToDocxOptions(markdown, options = defaultOptions) {
    try {
